"""
Hiermit bestätige, dass ich mich mit niemenandem über dieses Testat
ausgetauscht habe.
...
class Test_Wetterstation(unittest.TestCase):
    ...
    def test_set_search_criteria(self):
        ...
        self.assertEqual(self.weather_station.set_search_criteria(
            "Bern"), "Bern")
    ...
    def test_get_results_with_bad_entry(self):
        """Test the get_results function whether it gives result with
         an int value"""
...
class OpenWeather_Station(Wetterstation):
    ...
    def set_search_criteria(self, location):
        ...
        # self.location = input("From which location? eg Zurich, Luzern: ") or
        # "Luzern"
...
def read_factory() -> Stations_Factory:
    ...
    while True:
        export_format = input("Enter desired service provider"
                              "(openweather,opendataswiss): ") or "openweather"
